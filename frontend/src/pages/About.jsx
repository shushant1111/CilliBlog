  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Shushant excels in
      ...
      <br />
      <span>
        Shushant is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Shushant is a big fan of cricket and
        holds immense admiration for <strong> King Kohli.</strong> 
      </p>
    </div>
  );
}
